...
columnnames = data.axes

views_index = [['n_tokens_title', 'n_tokens_content', 'n_unique_tokens', 'n_non_stop_words', 'n_non_stop_unique_tokens', 'num_hrefs', 'num_self_hrefs', 'num_imgs', 'num_videos', 'average_token_length', 'num_keywords'],
...
print(columnnames)
shares = data.loc[:,"shares"].values

n, bins, patches = plt.hist(shares, bins=range(0,10000,500))
print(n)
print(bins)
print(patches)
plt.show()